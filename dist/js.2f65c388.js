...
},{"ev-emitter":"BQvw"}],"W1ZM":[function(require,module,exports) {
"use strict";
...
},{"./gsap-core.js":"TNS6","./CSSPlugin.js":"bp4Z"}],"qr24":[function(require,module,exports) {
"use strict";
...
var Navigation = /*#__PURE__*/function () {
  function Navigation(el) {
    ...
    this.DOM = {
      links: _toConsumableArray(el.querySelectorAll('a'))
    };
    this.screens = [];

    _toConsumableArray(document.querySelectorAll('.screen__item')).forEach(function (el) {
      return _this.screens.push(new _screen.default(el));
    });
  ...
  _createClass(Navigation, [{
    ...
    value: function initEvents() {
      ...
      this.onMouseEnter = function (ev) {
        var position = _this2.DOM.links.indexOf(ev.target);

        if (position === _this2.current) {
          return false;
        }

        var currentScreen = _this2.screens[_this2.current];
        var nextScreen = _this2.screens[position];
        _this2.current = position;

        _gsap.gsap.killTweensOf([currentScreen.DOM.el, nextScreen.DOM.el]);

        _this2.hideScreen(currentScreen);

        _this2.showScreen(nextScreen);
      };

      this.DOM.links.forEach(function (link) {
        link.addEventListener('mouseenter', _this2.onMouseEnter);
      });
    }
  }, {
    key: "showScreen",
    value: function showScreen(screen) {
      _gsap.gsap.timeline().set(screen.DOM.el, {
        opacity: 1,
        zIndex: 1
      }).to(screen.DOM.full, {
        duration: 1.8,
    ...
    value: function hideScreen(screen) {
      _gsap.gsap.timeline().set(screen.DOM.el, {
        ...
        onComplete: function onComplete() {
          return _gsap.gsap.set(screen.DOM.el, {
            zIndex: 1
          });
        }
      });
...
},{"./screen":"W1ZM","gsap":"TpQl"}],"QvaY":[function(require,module,exports) {
"use strict";
...
Promise.all([preloadImages(), preloadFonts()]).then(function () {
  new _navigation.default(document.querySelector('.menu')); // Remove loader (loading class)

  document.body.classList.remove('loading');
});
},{"imagesloaded":"lc7f","./navigation":"qr24"}]},{},["QvaY"], null)